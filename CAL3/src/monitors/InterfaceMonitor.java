 ...
 * @author mario
 */
public class InterfaceMonitor extends javax.swing.JFrame {
    ...
    public InterfaceMonitor() {
        initComponents();
        book = new BookMonitor(jTextArea1, jTextArea2, jProgressBar1);
        for (int i = 0; i < 10; i++) {
            new WriterMonitor(i, book);
        }
        for (int i = 20; i < 35; i++) {
            new ReaderMonitor(i, book, jTextArea3);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Writers & Readers (Monitors)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceMonitor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceMonitor().setVisible(true);
            }
        });
    }
